...
#include "Commands/_CMG_EndOutOfZoneAutonomous.h"
...
//	centered = false;
	...
	autonomousCommand = new _CMG_AutonomousMainCommand(1, 1, false);

	chooser = new frc::SendableChooser<frc::Command*>();
	chooser->AddDefault("Do Nothing", new _CMG_AutonomousMainCommand(0, 0, true));
	chooser->AddObject("Just Drive", new _CMG_AutonomousMainCommand(0, 0, false));
	chooser->AddObject("No Containers, All Totes", new _CMG_AutonomousMainCommand(0, 3, false));
	chooser->AddObject("1 Containers, All Totes", new _CMG_AutonomousMainCommand(1, 3, false));
	chooser->AddObject("2 Containers, All Totes", new _CMG_AutonomousMainCommand(2, 3, false));
	chooser->AddObject("3 Containers, All Totes", new _CMG_AutonomousMainCommand(3, 3, false));
	chooser->AddObject("No Containers, 1 Tote", new _CMG_AutonomousMainCommand(0, 1, false));
	chooser->AddObject("No Containers, 2 Totes", new _CMG_AutonomousMainCommand(0, 2, false));
	chooser->AddObject("1 Container", new _CMG_AutonomousMainCommand(1, 0, false));
	chooser->AddObject("2 Containers", new _CMG_AutonomousMainCommand(2, 0, false));
	chooser->AddObject("End out of zone", new _CMG_EndOutOfZoneAutonomous());
...
//	} else {
//		autonomousCommand = new _CMG_AutonomousMainCommand(0, 0, true);
//	}
