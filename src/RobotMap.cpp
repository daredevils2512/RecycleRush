...
Relay* RobotMap::intakeSystemIntakeActuator = NULL;
...
CANTalon* RobotMap::clawPIDClawMotor = NULL;
...
void RobotMap::init() {
	...
	intakeSystemIntakeActuator = new Relay(0);
	lw->AddActuator("Intake System", "IntakeActuator", intakeSystemIntakeActuator);
	...
	clawPIDClawMotor = new CANTalon(3);
//	lw->AddActuator("ClawPID", "Claw Motor", (CANTalon*) clawMotor);
}
