...
Solenoid* RobotMap::intakeSystemSolenoid1 = NULL;
Solenoid* RobotMap::intakeSystemSolenoid2 = NULL;
...
void RobotMap::init() {
	...
	intakeSystemSolenoid1 = new Solenoid(0, 0);
	lw->AddActuator("Intake System", "Solenoid 1", intakeSystemSolenoid1);
	
	intakeSystemSolenoid2 = new Solenoid(1, 1);
	lw->AddActuator("Intake System", "Solenoid 2", intakeSystemSolenoid2);
