...
Encoder* RobotMap::magazineQuadratureEncoder1 = NULL;
Encoder* RobotMap::clawQuadratureEncoder1 = NULL;
...
void RobotMap::init() {
	...
	magazineQuadratureEncoder1 = new Encoder(10, 11, false, Encoder::k4X);
	lw->AddSensor("Magazine", "Quadrature Encoder 1", magazineQuadratureEncoder1);
	magazineQuadratureEncoder1->SetDistancePerPulse(1.0);
        magazineQuadratureEncoder1->SetPIDSourceParameter(Encoder::kRate);
	clawQuadratureEncoder1 = new Encoder(8, 9, false, Encoder::k4X);
	lw->AddSensor("Claw", "Quadrature Encoder 1", clawQuadratureEncoder1);
	clawQuadratureEncoder1->SetDistancePerPulse(1.0);
        clawQuadratureEncoder1->SetPIDSourceParameter(Encoder::kRate);
